...
namespace An3sGunJam
{
	...
	{
        //the most useful code you will see in your life. makes it so you dont neet to convert messages you want to log to strings.
        public static void Log(object msg, string color = "#FFFFFF")
		{
            ETGModConsole.Log($"<color={color}>{msg}</color>");
        }

        //just some basic shite.
